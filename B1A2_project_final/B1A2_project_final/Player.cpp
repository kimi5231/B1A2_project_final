...
void CPlayer::Update(float fTimeElapsed)
{
	...
	// 플레이어의 새로운 위치가 유효한 위치가 아닐 수도 있고 
...
CCamera* CPlayer::OnChangeCamera(DWORD nNewCameraMode, DWORD nCurrentCameraMode)
{
	...
	// 특히, y-축 방향의 움직임이 자유롭다. 그러므로 플레이어의 위치는 공중(위치 벡터의 y-좌표가 0보다 크다)이 될 수 있다. 
...
// Up 벡터가 두 번째 행 벡터, Look 벡터가 세 번째 행 벡터, 
...
{
	//비행기 메쉬를 생성한다.
	CMesh* pAirplaneMesh = new CAirplaneMeshDiffused(pd3dDevice, pd3dCommandList, 5.0f, 5.0f, 1.0f, XMFLOAT4(0.0f, 0.5f, 0.0f, 0.0f));
	...
	//플레이어의 위치를 설정한다.
	SetPosition(XMFLOAT3(0.0f, 0.0f, 700.0f));
