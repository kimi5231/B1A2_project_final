...
{
	return(CShader::CompileShaderFromFile((LPWSTR)L"Shaders.hlsl", "VSPlayer", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CPlayerShader::CreatePixelShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile((LPWSTR)L"Shaders.hlsl", "PSPlayer", "ps_5_1", ppd3dShaderBlob));
}
...
{
	return(CShader::CompileShaderFromFile((LPWSTR)L"Shaders.hlsl", "VSLighting", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CObjectsShader::CreatePixelShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile((LPWSTR)L"Shaders.hlsl", "PSLighting", "ps_5_1", ppd3dShaderBlob));
}
