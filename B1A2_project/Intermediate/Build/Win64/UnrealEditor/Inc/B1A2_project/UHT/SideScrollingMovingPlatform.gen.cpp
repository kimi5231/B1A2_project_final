...
B1A2_PROJECT_API UClass* Z_Construct_UClass_ASideScrollingMovingPlatform();
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ASideScrollingMovingPlatform_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_USideScrollingInteractable_NoRegister, (int32)VTABLE_OFFSET(ASideScrollingMovingPlatform, ISideScrollingInteractable), false },  // 135154486
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_B1A2_project_Source_B1A2_project_Variant_SideScrolling_Gameplay_SideScrollingMovingPlatform_h__Script_B1A2_project_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASideScrollingMovingPlatform, ASideScrollingMovingPlatform::StaticClass, TEXT("ASideScrollingMovingPlatform"), &Z_Registration_Info_UClass_ASideScrollingMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASideScrollingMovingPlatform), 4100786140U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_B1A2_project_Source_B1A2_project_Variant_SideScrolling_Gameplay_SideScrollingMovingPlatform_h__Script_B1A2_project_1740531086(TEXT("/Script/B1A2_project"),
	Z_CompiledInDeferFile_FID_B1A2_project_Source_B1A2_project_Variant_SideScrolling_Gameplay_SideScrollingMovingPlatform_h__Script_B1A2_project_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_B1A2_project_Source_B1A2_project_Variant_SideScrolling_Gameplay_SideScrollingMovingPlatform_h__Script_B1A2_project_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
